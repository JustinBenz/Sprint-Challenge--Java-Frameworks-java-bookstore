...
public class BookControllerUnitTestNoDB
{
    ...
    public void listAllBooks() throws
            Exception
    {
        this.mockMvc.perform(MockMvcRequestBuilders.get("books/books")).andDo(print()).andExpect(status().isOk());
    }
    ...
    public void getBookById() throws
            Exception
    {
        this.mockMvc.perform(MockMvcRequestBuilders.get("books/book/{bookId}")).andDo(print()).andExpect(status().isOk());
    }
    ...
    public void deleteBookById() throws
            Exception
    {
        mockMvc.perform(MockMvcRequestBuilders.delete("/book/{id}", 5)).andDo(print()).andExpect(status().isOk());
    }
}